<template>
  <div>
    ...
    <nav-bread>OrderConfirm</nav-bread>
    ...
    <div class="container">
      <div class="checkout-order">
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap" @click='makePayment'>
        ...
        this.$http.get('/api/getCart').then(res => {
          if (res.data.status === ERR_OK) {
            ...
            this.goodsList.forEach(item => {
              if (item.checked) {
                this.goodsFilter.push(item)
                this.subtotal += Number(item.salePrice) * Number(item.productNum)
              }
            })
